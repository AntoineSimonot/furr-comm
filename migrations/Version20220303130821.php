 ...
 */
final class Version20220303130821 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE media_object ADD content_url VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
