 ...
 */
final class Version20220303200232 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE art ADD artist_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE art ADD CONSTRAINT FK_FC35D654B7970CF8 FOREIGN KEY (artist_id) REFERENCES `user` (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE art DROP artist_id, CHANGE title title VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description description LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
