 ...
 */
final class Version20220303185241 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE art ADD CONSTRAINT FK_FC35D654B7970CF8 FOREIGN KEY (artist_id) REFERENCES `user` (id) ON DELETE CASCADE');
    }
